...
\begin{document}
    ...
    \begin{abstract}
        ...
        sequenced than those that are not. To investigate this, a large-scale
        statistical analysis of the database was performed, and showed this was
        indeed the case. Specific patterns as to which viruses are more likely
        to be sequenced are also documented and discussed.
    \end{abstract}
